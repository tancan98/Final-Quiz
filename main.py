...
class Quiz:#Quiz page
  ...
  def __init__(self, parent):
    ...
    self.variable1 = Radiobutton (self.quiz_frame, text = question_solution [qnum][1], font=("times new roman", "12"), bg="gold", value=1, variable=self.constant1, pady=10)
    self.variable1.grid(row=1, sticky=W)#button 1

    self.variable2 = Radiobutton (self.quiz_frame, text = question_solution [qnum][2], font=("times new roman", "12"), bg="gold", value=2, variable=self.constant1, pady=10)
    self.variable2.grid(row=2, sticky=W)#button 2

    self.variable3 = Radiobutton (self.quiz_frame, text = question_solution [qnum][3], font=("times new roman", "12"), bg="gold", value=3, variable=self.constant1, pady=10)
    self.variable3.grid(row=3, sticky=W)#button 3

    self.variable4 = Radiobutton (self.quiz_frame, text = question_solution [qnum][4], font=("times new roman", "12"), bg="gold", value=4, variable=self.constant1, pady=10)
    self.variable4.grid(row=4, sticky=W)#button 4
  ...
  def questions_system(self):
     randomiser()
     self.constant1.set(0)
     self.question_label.config(text=question_solution [qnum][0])
     self.variable1.config(text=question_solution [qnum][1])
     self.variable2.config(text=question_solution [qnum][2])
     self.variable3.config(text=question_solution [qnum][3])
     self.variable4.config(text=question_solution [qnum][4])

#this is the score system that tells the users what their score is
  def trial_progression(self):
      global score 
      scr_tab=self.score_label
      choice=self.constant1.get()
  ...
  def end_window(self):
    ...
    name = names[0]
    open_end_object = EndStarter()#opens end page



class EndStarter:# End page
